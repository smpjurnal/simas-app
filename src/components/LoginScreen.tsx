...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin, error, isLoggingIn }) => {
  ...
  return (
    ...
    >
      <div className="h-full w-full grid place-items-center p-4 overflow-y-auto">
        <div className="w-full max-w-md">
          <div
            className="bg-slate-800/70 backdrop-blur-lg shadow-2xl rounded-xl p-6 transition-all duration-300"
          >
