...
const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  useEffect(() => {
    if (isModalOpen) {
      if (editingUser) {
        ...
        setFormData({ ...initialFormData, ...editingUser, password: '' }); // Kosongkan password saat edit
      } else {
  ...
  const generateRandomPassword = () => {
    ...
    displayNotification('Password baru telah dibuat.', 'info', 2000);
  };
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-2xl max-h-[85vh] flex flex-col">
            ...
            <form id="user-form" onSubmit={handleUserSubmit} className="flex-1 min-h-0 overflow-y-auto p-6 space-y-4">
              <div className="flex items-center space-x-4">
                  ...
                  <div>
                      <button type="button" onClick={handleAvatarClick} className="text-sm text-blue-700 bg-blue-100 hover:bg-blue-200 dark:bg-blue-900 dark:text-blue-200 dark:hover:bg-blue-800 font-medium rounded-lg px-4 py-2">
                          Ganti Foto
                      </button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 animate-fade-in p-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md">
                ...
                <div className="mt-6 flex justify-end space-x-3">
                    <button onClick={() => setIsDeleteConfirmOpen(false)} disabled={isSubmitting} className="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300 dark:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-500 disabled:opacity-50">Batal</button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 animate-fade-in p-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md">
                ...
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
                    Yakin ingin mereset data? Tindakan ini akan menghapus semua pengguna dan jurnal, lalu mengembalikannya ke data awal.
                    <strong className="block mt-2">Tindakan ini tidak dapat dibatalkan.</strong>
                </p>
                <div className="mt-6 flex justify-end space-x-3">
